...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[11] = new State(new int[]{23,18,21,19,18,20},new int[]{-2,12,-4,30,-5,29,-3,17});
    states[12] = new State(new int[]{13,13,14,23,4,-13,10,-13});
    states[13] = new State(new int[]{23,18,21,19,18,20},new int[]{-4,14,-5,29,-3,17});
    states[14] = new State(new int[]{15,15,16,25,17,27,13,-14,14,-14,4,-14,10,-14,19,-14,23,-14,3,-14,5,-14,11,-14,12,-14});
    ...
    states[20] = new State(new int[]{23,18,21,19,18,20},new int[]{-2,21,-4,30,-5,29,-3,17});
    states[21] = new State(new int[]{19,22,13,13,14,23});
    states[22] = new State(-23);
    states[23] = new State(new int[]{23,18,21,19,18,20},new int[]{-4,24,-5,29,-3,17});
    states[24] = new State(new int[]{15,15,16,25,17,27,13,-15,14,-15,4,-15,10,-15,19,-15,23,-15,3,-15,5,-15,11,-15,12,-15});
    states[25] = new State(new int[]{23,18,21,19,18,20},new int[]{-5,26,-3,17});
    states[26] = new State(-18);
    states[27] = new State(new int[]{23,18,21,19,18,20},new int[]{-5,28,-3,17});
    states[28] = new State(-19);
    states[29] = new State(-20);
    states[30] = new State(new int[]{15,15,16,25,17,27,13,-16,14,-16,4,-16,10,-16,19,-16,23,-16,3,-16,5,-16,11,-16,12,-16});
    states[31] = new State(-6);
    states[32] = new State(-7);
    states[33] = new State(new int[]{23,18,21,19,18,20},new int[]{-2,34,-4,30,-5,29,-3,17});
    ...
    states[38] = new State(new int[]{23,18,21,19,18,20},new int[]{-2,39,-4,30,-5,29,-3,17});
    ...
    states[44] = new State(new int[]{20,45,4,-28,10,-28});
