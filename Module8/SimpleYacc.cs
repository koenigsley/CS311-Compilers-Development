...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "write", "empty", "var", "varlist", "if", "while", "stlist", "$accept", 
      "Anon@1", };
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{28,18,3,4,5,33,11,37,12,42,21,50,24,57,4,-13,10,-13},new int[]{-16,5,-6,61,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-14,49,-15,56});
    states[5] = new State(new int[]{4,6,10,7});
    states[6] = new State(-26);
    states[7] = new State(new int[]{28,18,3,4,5,33,11,37,12,42,21,50,24,57,4,-13,10,-13},new int[]{-6,8,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-14,49,-15,56});
    states[8] = new State(-4);
    states[9] = new State(-5);
    states[10] = new State(new int[]{6,11});
    states[11] = new State(new int[]{28,18,26,19,18,20},new int[]{-2,12,-4,30,-5,29,-3,17});
    states[12] = new State(new int[]{13,13,14,23,4,-15,10,-15,23,-15});
    states[13] = new State(new int[]{28,18,26,19,18,20},new int[]{-4,14,-5,29,-3,17});
    states[14] = new State(new int[]{15,15,16,25,17,27,13,-16,14,-16,4,-16,10,-16,23,-16,19,-16,28,-16,3,-16,5,-16,11,-16,12,-16,21,-16,24,-16,22,-16,25,-16});
    states[15] = new State(new int[]{28,18,26,19,18,20},new int[]{-5,16,-3,17});
    states[16] = new State(-19);
    states[17] = new State(-23);
    states[18] = new State(-14);
    states[19] = new State(-24);
    states[20] = new State(new int[]{28,18,26,19,18,20},new int[]{-2,21,-4,30,-5,29,-3,17});
    states[21] = new State(new int[]{19,22,13,13,14,23});
    states[22] = new State(-25);
    states[23] = new State(new int[]{28,18,26,19,18,20},new int[]{-4,24,-5,29,-3,17});
    states[24] = new State(new int[]{15,15,16,25,17,27,13,-17,14,-17,4,-17,10,-17,23,-17,19,-17,28,-17,3,-17,5,-17,11,-17,12,-17,21,-17,24,-17,22,-17,25,-17});
    states[25] = new State(new int[]{28,18,26,19,18,20},new int[]{-5,26,-3,17});
    states[26] = new State(-20);
    states[27] = new State(new int[]{28,18,26,19,18,20},new int[]{-5,28,-3,17});
    states[28] = new State(-21);
    states[29] = new State(-22);
    states[30] = new State(new int[]{15,15,16,25,17,27,13,-18,14,-18,4,-18,10,-18,23,-18,19,-18,28,-18,3,-18,5,-18,11,-18,12,-18,21,-18,24,-18,22,-18,25,-18});
    states[31] = new State(-6);
    states[32] = new State(-7);
    states[33] = new State(new int[]{28,18,26,19,18,20},new int[]{-2,34,-4,30,-5,29,-3,17});
    states[34] = new State(new int[]{13,13,14,23,28,18,3,4,5,33,11,37,12,42,21,50,24,57,4,-13,10,-13,23,-13},new int[]{-6,35,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-14,49,-15,56});
    states[35] = new State(-27);
    states[36] = new State(-8);
    states[37] = new State(new int[]{18,38});
    states[38] = new State(new int[]{28,18,26,19,18,20},new int[]{-2,39,-4,30,-5,29,-3,17});
    states[39] = new State(new int[]{19,40,13,13,14,23});
    states[40] = new State(-28);
    states[41] = new State(-9);
    states[42] = new State(-29,new int[]{-18,43});
    states[43] = new State(new int[]{28,18},new int[]{-13,44,-3,47});
    states[44] = new State(new int[]{20,45,4,-30,10,-30,23,-30});
    states[45] = new State(new int[]{28,18},new int[]{-3,46});
    states[46] = new State(-32);
    states[47] = new State(-31);
    states[48] = new State(-10);
    states[49] = new State(-11);
    states[50] = new State(new int[]{28,18,26,19,18,20},new int[]{-2,51,-4,30,-5,29,-3,17});
    states[51] = new State(new int[]{22,52,13,13,14,23});
    states[52] = new State(new int[]{28,18,3,4,5,33,11,37,12,42,21,50,24,57,4,-13,10,-13,23,-13},new int[]{-6,53,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-14,49,-15,56});
    states[53] = new State(new int[]{23,54,4,-33,10,-33});
    states[54] = new State(new int[]{28,18,3,4,5,33,11,37,12,42,21,50,24,57,4,-13,10,-13,23,-13},new int[]{-6,55,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-14,49,-15,56});
    states[55] = new State(-34);
    states[56] = new State(-12);
    states[57] = new State(new int[]{28,18,26,19,18,20},new int[]{-2,58,-4,30,-5,29,-3,17});
    states[58] = new State(new int[]{25,59,13,13,14,23});
    states[59] = new State(new int[]{28,18,3,4,5,33,11,37,12,42,21,50,24,57,4,-13,10,-13,23,-13},new int[]{-6,60,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-14,49,-15,56});
    states[60] = new State(-35);
    states[61] = new State(-3);

    rules[1] = new Rule(-17, new int[]{-1,2});
    rules[2] = new Rule(-1, new int[]{-8});
    rules[3] = new Rule(-16, new int[]{-6});
    rules[4] = new Rule(-16, new int[]{-16,10,-6});
    ...
    rules[14] = new Rule(-3, new int[]{28});
    rules[15] = new Rule(-7, new int[]{-3,6,-2});
    rules[16] = new Rule(-2, new int[]{-2,13,-4});
    rules[17] = new Rule(-2, new int[]{-2,14,-4});
    rules[18] = new Rule(-2, new int[]{-4});
    rules[19] = new Rule(-4, new int[]{-4,15,-5});
    rules[20] = new Rule(-4, new int[]{-4,16,-5});
    rules[21] = new Rule(-4, new int[]{-4,17,-5});
    rules[22] = new Rule(-4, new int[]{-5});
    rules[23] = new Rule(-5, new int[]{-3});
    rules[24] = new Rule(-5, new int[]{26});
    rules[25] = new Rule(-5, new int[]{18,-2,19});
    rules[26] = new Rule(-8, new int[]{3,-16,4});
    rules[27] = new Rule(-9, new int[]{5,-2,-6});
    rules[28] = new Rule(-10, new int[]{11,18,-2,19});
    rules[29] = new Rule(-18, new int[]{});
    rules[30] = new Rule(-12, new int[]{12,-18,-13});
    rules[31] = new Rule(-13, new int[]{-3});
    rules[32] = new Rule(-13, new int[]{-13,20,-3});
    rules[33] = new Rule(-14, new int[]{21,-2,22,-6});
    rules[34] = new Rule(-14, new int[]{21,-2,22,-6,23,-6});
    rules[35] = new Rule(-15, new int[]{24,-2,25,-6});
  }
...
{ CurrentSemanticValue.stVal = new IfNode(ValueStack[ValueStack.Depth-5].eVal, ValueStack[ValueStack.Depth-3].stVal, ValueStack[ValueStack.Depth-1].stVal); }
        break;
      case 35: // while -> WHILE, expr, DO, statement
