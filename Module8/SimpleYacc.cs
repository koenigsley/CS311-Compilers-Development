...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[11] = new State(new int[]{30,18,28,19,18,20},new int[]{-2,12,-4,30,-5,29,-3,17});
    states[12] = new State(new int[]{13,13,14,23,4,-16,10,-16,27,-16,23,-16});
    states[13] = new State(new int[]{30,18,28,19,18,20},new int[]{-4,14,-5,29,-3,17});
    states[14] = new State(new int[]{15,15,16,25,17,27,13,-17,14,-17,4,-17,10,-17,27,-17,23,-17,19,-17,30,-17,3,-17,5,-17,11,-17,12,-17,21,-17,24,-17,26,-17,22,-17,25,-17});
    states[15] = new State(new int[]{30,18,28,19,18,20},new int[]{-5,16,-3,17});
    states[16] = new State(-20);
    states[17] = new State(-24);
    states[18] = new State(-15);
    states[19] = new State(-25);
    states[20] = new State(new int[]{30,18,28,19,18,20},new int[]{-2,21,-4,30,-5,29,-3,17});
    states[21] = new State(new int[]{19,22,13,13,14,23});
    states[22] = new State(-26);
    states[23] = new State(new int[]{30,18,28,19,18,20},new int[]{-4,24,-5,29,-3,17});
    states[24] = new State(new int[]{15,15,16,25,17,27,13,-18,14,-18,4,-18,10,-18,27,-18,23,-18,19,-18,30,-18,3,-18,5,-18,11,-18,12,-18,21,-18,24,-18,26,-18,22,-18,25,-18});
    states[25] = new State(new int[]{30,18,28,19,18,20},new int[]{-5,26,-3,17});
    states[26] = new State(-21);
    states[27] = new State(new int[]{30,18,28,19,18,20},new int[]{-5,28,-3,17});
    states[28] = new State(-22);
    states[29] = new State(-23);
    states[30] = new State(new int[]{15,15,16,25,17,27,13,-19,14,-19,4,-19,10,-19,27,-19,23,-19,19,-19,30,-19,3,-19,5,-19,11,-19,12,-19,21,-19,24,-19,26,-19,22,-19,25,-19});
    states[31] = new State(-6);
    states[32] = new State(-7);
    states[33] = new State(new int[]{30,18,28,19,18,20},new int[]{-2,34,-4,30,-5,29,-3,17});
    ...
    states[38] = new State(new int[]{30,18,28,19,18,20},new int[]{-2,39,-4,30,-5,29,-3,17});
    ...
    states[44] = new State(new int[]{20,45,4,-31,10,-31,27,-31,23,-31});
    ...
    states[50] = new State(new int[]{30,18,28,19,18,20},new int[]{-2,51,-4,30,-5,29,-3,17});
    ...
    states[57] = new State(new int[]{30,18,28,19,18,20},new int[]{-2,58,-4,30,-5,29,-3,17});
    ...
    states[64] = new State(new int[]{30,18,28,19,18,20},new int[]{-2,65,-4,30,-5,29,-3,17});
