...
public enum Tokens {
    ...
    TO=13,WRITE=14,LPAR=15,RPAR=16,INUM=17,RNUM=18,
    ID=19};
...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{19,14,3,4,5,18,8,22,10,27,12,32,14,41},new int[]{-10,5,-4,45,-3,9,-2,10,-11,16,-5,17,-6,21,-7,26,-8,31,-9,40});
    states[5] = new State(new int[]{4,6,7,7});
    states[6] = new State(-16);
    states[7] = new State(new int[]{19,14,3,4,5,18,8,22,10,27,12,32,14,41},new int[]{-4,8,-3,9,-2,10,-11,16,-5,17,-6,21,-7,26,-8,31,-9,40});
    states[8] = new State(-4);
    states[9] = new State(-5);
    states[10] = new State(new int[]{6,11});
    states[11] = new State(new int[]{19,14,17,15},new int[]{-1,12,-2,13});
    ...
    states[18] = new State(new int[]{19,14,17,15},new int[]{-1,19,-2,13});
    states[19] = new State(new int[]{19,14,3,4,5,18,8,22,10,27,12,32,14,41},new int[]{-4,20,-3,9,-2,10,-11,16,-5,17,-6,21,-7,26,-8,31,-9,40});
    states[20] = new State(-17);
    states[21] = new State(-8);
    states[22] = new State(new int[]{19,14,17,15},new int[]{-1,23,-2,13});
    states[23] = new State(new int[]{9,24});
    states[24] = new State(new int[]{19,14,3,4,5,18,8,22,10,27,12,32,14,41},new int[]{-4,25,-3,9,-2,10,-11,16,-5,17,-6,21,-7,26,-8,31,-9,40});
    states[25] = new State(-18);
    states[26] = new State(-9);
    states[27] = new State(new int[]{19,14,3,4,5,18,8,22,10,27,12,32,14,41},new int[]{-4,28,-3,9,-2,10,-11,16,-5,17,-6,21,-7,26,-8,31,-9,40});
    states[28] = new State(new int[]{11,29});
    states[29] = new State(new int[]{19,14,17,15},new int[]{-1,30,-2,13});
    states[30] = new State(-19);
    states[31] = new State(-10);
    states[32] = new State(new int[]{19,14},new int[]{-2,33});
    states[33] = new State(new int[]{6,34});
    states[34] = new State(new int[]{19,14,17,15},new int[]{-1,35,-2,13});
    states[35] = new State(new int[]{13,36});
    states[36] = new State(new int[]{19,14,17,15},new int[]{-1,37,-2,13});
    states[37] = new State(new int[]{9,38});
    states[38] = new State(new int[]{19,14,3,4,5,18,8,22,10,27,12,32,14,41},new int[]{-4,39,-3,9,-2,10,-11,16,-5,17,-6,21,-7,26,-8,31,-9,40});
    states[39] = new State(-20);
    states[40] = new State(-11);
    states[41] = new State(new int[]{15,42});
    states[42] = new State(new int[]{19,14,17,15},new int[]{-1,43,-2,13});
    ...
    rules[3] = new Rule(-10, new int[]{-4});
    rules[4] = new Rule(-10, new int[]{-10,7,-4});
    rules[5] = new Rule(-4, new int[]{-3});
    rules[6] = new Rule(-4, new int[]{-11});
    ...
    rules[13] = new Rule(-3, new int[]{-2,6,-1});
    rules[14] = new Rule(-1, new int[]{-2});
    rules[15] = new Rule(-1, new int[]{17});
    rules[16] = new Rule(-11, new int[]{3,-10,4});
    rules[17] = new Rule(-5, new int[]{5,-1,-4});
    rules[18] = new Rule(-6, new int[]{8,-1,9,-4});
    rules[19] = new Rule(-7, new int[]{10,-4,11,-1});
    rules[20] = new Rule(-8, new int[]{12,-2,6,-1,13,-1,9,-4});
    rules[21] = new Rule(-9, new int[]{14,15,-1,16});
  }
...
{ CurrentSemanticValue.stVal = new WhileNode(ValueStack[ValueStack.Depth-3].eVal, ValueStack[ValueStack.Depth-1].stVal); }
        break;
      case 19: // repeat -> REPEAT, statement, UNTIL, expr
...
{ CurrentSemanticValue.stVal = new ForNode(ValueStack[ValueStack.Depth-7].eVal as IdNode, ValueStack[ValueStack.Depth-5].eVal, ValueStack[ValueStack.Depth-3].eVal, ValueStack[ValueStack.Depth-1].stVal); }
        break;
      case 21: // write -> WRITE, LPAR, expr, RPAR
