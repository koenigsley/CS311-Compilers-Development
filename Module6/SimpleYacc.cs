...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{22,14,3,4,5,18,8,22,10,27,12,32,14,41,17,48},new int[]{-11,5,-4,52,-3,9,-2,10,-12,16,-5,17,-6,21,-7,26,-8,31,-9,40,-10,45});
    states[5] = new State(new int[]{4,6,7,7});
    states[6] = new State(-17);
    states[7] = new State(new int[]{22,14,3,4,5,18,8,22,10,27,12,32,14,41,17,48},new int[]{-4,8,-3,9,-2,10,-12,16,-5,17,-6,21,-7,26,-8,31,-9,40,-10,45});
    ...
    states[19] = new State(new int[]{22,14,3,4,5,18,8,22,10,27,12,32,14,41,17,48},new int[]{-4,20,-3,9,-2,10,-12,16,-5,17,-6,21,-7,26,-8,31,-9,40,-10,45});
    ...
    states[24] = new State(new int[]{22,14,3,4,5,18,8,22,10,27,12,32,14,41,17,48},new int[]{-4,25,-3,9,-2,10,-12,16,-5,17,-6,21,-7,26,-8,31,-9,40,-10,45});
    states[25] = new State(-19);
    states[26] = new State(-9);
    states[27] = new State(new int[]{22,14,3,4,5,18,8,22,10,27,12,32,14,41,17,48},new int[]{-4,28,-3,9,-2,10,-12,16,-5,17,-6,21,-7,26,-8,31,-9,40,-10,45});
    ...
    states[32] = new State(new int[]{22,14},new int[]{-2,33});
    states[33] = new State(new int[]{6,34});
    states[34] = new State(new int[]{22,14,20,15},new int[]{-1,35,-2,13});
    states[35] = new State(new int[]{13,36});
    states[36] = new State(new int[]{22,14,20,15},new int[]{-1,37,-2,13});
    states[37] = new State(new int[]{9,38});
    states[38] = new State(new int[]{22,14,3,4,5,18,8,22,10,27,12,32,14,41,17,48},new int[]{-4,39,-3,9,-2,10,-12,16,-5,17,-6,21,-7,26,-8,31,-9,40,-10,45});
    states[39] = new State(-21);
    states[40] = new State(-11);
    states[41] = new State(new int[]{15,42});
    states[42] = new State(new int[]{22,14,20,15},new int[]{-1,43,-2,13});
    states[43] = new State(new int[]{16,44});
    states[44] = new State(-22);
    states[45] = new State(new int[]{19,46,4,-12,7,-12,11,-12});
    states[46] = new State(new int[]{22,14,3,4,5,18,8,22,10,27,12,32,14,41,17,48},new int[]{-4,47,-3,9,-2,10,-12,16,-5,17,-6,21,-7,26,-8,31,-9,40,-10,45});
    states[47] = new State(-24);
    states[48] = new State(new int[]{22,14,20,15},new int[]{-1,49,-2,13});
    states[49] = new State(new int[]{18,50});
    states[50] = new State(new int[]{22,14,3,4,5,18,8,22,10,27,12,32,14,41,17,48},new int[]{-4,51,-3,9,-2,10,-12,16,-5,17,-6,21,-7,26,-8,31,-9,40,-10,45});
    ...
    rules[20] = new Rule(-7, new int[]{10,-4,11,-1});
    rules[21] = new Rule(-8, new int[]{12,-2,6,-1,13,-1,9,-4});
    rules[22] = new Rule(-9, new int[]{14,15,-1,16});
    rules[23] = new Rule(-10, new int[]{17,-1,18,-4});
    rules[24] = new Rule(-10, new int[]{-10,19,-4});
  }
...
{ CurrentSemanticValue.stVal = new ForNode(ValueStack[ValueStack.Depth-7].eVal as IdNode, ValueStack[ValueStack.Depth-5].eVal, ValueStack[ValueStack.Depth-3].eVal, ValueStack[ValueStack.Depth-1].stVal); }
        break;
      case 22: // write -> WRITE, LPAR, expr, RPAR
